...
st.markdown("<div style='text-align: center;color: white;font-size: 20px'>جامعة محمد البشير الإبراهيمي - برج بوعريريج</div>", unsafe_allow_html=True)
st.markdown("<div style='text-align: center;color: white;'>كلية الحقوق والعلوم السياسية</div>", unsafe_allow_html=True)
st.markdown("---")
st.markdown("""
