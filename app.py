...
if not st.session_state.logged_in:
    ...
    with cols[1]:
        st.markdown('<div style="text-align:center;"><img src="https://raw.githubusercontent.com/SAMIR-MALEK/memoire-depot-2026/main/logo.png" width="60"></div>', unsafe_allow_html=True)
