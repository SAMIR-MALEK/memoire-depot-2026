...
def update_registration(note_number, student1, student2=None):
    ...
    ].index[0] + 2  # +2 بسبب العنوان والاندكس
    ...
    updates2 = [
        ...
        {"range": f"Feuille 1!{chr(64+memo_cols.index('رقم المذكرة')+1)}{memo_row_idx}", "values": [[note_number]]}
    ]
    if student2 is not None:
...
# ---------------- واجهة تسجيل المذكرة بعد الدخول ----------------
    ...
    st.markdown("<p style='text-align:center; color:#FFFF00;'>⚠️ يجب الاتصال بالأستاذ المشرف للحصول على كلمة السر</p>", unsafe_allow_html=True)
